...
const FAQ = () => {
    return (
        <section className="min-h-[70vh] flex flex-col justify-center items-center">
            <p className="text-4xl sm:text-7xl font-bold relative z-20 bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-500 py-8 text-center h-[150px]">
            ...
            <Accordion type="single" collapsible className="w-1/2">
                ...
                <AccordionItem value="item-3">
                    <AccordionTrigger className="text-xl">Can I upgrade or downgrade my plan anytime?</AccordionTrigger>
                    <AccordionContent className="text-lg">
                ...
                <AccordionItem value="item-4">
                    <AccordionTrigger className="text-xl">How secure is my data with SyncSales?</AccordionTrigger>
                    <AccordionContent className="text-lg">
